...
<div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Alumnos Matriculados <span>- Notas</span></h2>
                </div>

                <!--<form action="<?php echo SERVERURL;?>docenteReporteAlumnosMatriculadosNotasPDF" method="post" target="_blank">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="hidden" name="reporte_name" value="Reporte de Notas">
                    ...
                    <?php  
                        echo $ins->paginador_alumnos_notas_controlador($_SESSION["privilegio_csm"],$_SESSION["codigo_cuenta_csm"], $asignacion, $modulo, $grupo);
                    ?>
