<div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Registrar <span>Categoría</span></h2>
                </div>

                <form action="<?php echo SERVERURL;?>ajax/categoriaAjax.php" method="POST" data-form="guardar" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
