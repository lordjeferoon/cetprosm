<div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Seleccionar Módulo <span>para registrar notas</span> </h2>
                </div>
                ...
                <br>
                    ...
                    <?php  
                        ...
                        echo $ins->paginador_docente_seleccionar_nota_controlador($pagina[1],10,$_SESSION["privilegio_csm"],$_SESSION["codigo_cuenta_csm"]);
                    ?>
