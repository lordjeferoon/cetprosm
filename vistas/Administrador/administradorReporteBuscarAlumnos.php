...
<div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Reporte de <span>Alumnos matriculado</span></h2>
                </div>
                ...
                <form action="<?php echo SERVERURL;?>administradorReporteAlumnosMatriculados/" method="POST">
                    <div class="form-row"> 
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <select  class="form-control" name="modulo">
                                <?php
                                    ...
                                    echo '<option value="0">SELECCIONE UN MÓDULO</option>';
                        ...
                        <div class="form-group col-md-3">
                            <label></label>
                            <button type="submit" class="btn boton-registrar btn-success w-100">Ver reporte</button>
                        </div>
                    </div>
                </form>
